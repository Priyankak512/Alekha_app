...
class AlekhaArchitectsInvoiceScreen extends StatefulWidget {
  const AlekhaArchitectsInvoiceScreen({super.key});

  @override
  State<AlekhaArchitectsInvoiceScreen> createState() =>
      _AlekhaArchitectsInvoiceScreenState();
}

class _AlekhaArchitectsInvoiceScreenState
    extends State<AlekhaArchitectsInvoiceScreen> {
  ...
  Future<void> _createPdf() async {
    ...
    Uint8List alekhaArchitectsRonakImage =
        (await rootBundle.load(PickImages.alekhaArchitectsRonakImage))
            .buffer
            .asUint8List();
                    ...
                    pw.Row(
                      ...
                      children: [
                        ...
                        pw.Container(
                          ...
                          decoration: pw.BoxDecoration(
                            image: pw.DecorationImage(
                              image: pw.MemoryImage(alekhaArchitectsRonakImage),
                              fit: pw.BoxFit.contain,
                            ),
                          ),
                          // ),
    ...
    await Printing.layoutPdf(
      name:
          '${projectNoController.text} INVOICE ${dateController.text.replaceAll('_', '/')} ${clientNameController.text.toUpperCase()} ALEKHA ARCHITECTS',
