...
class ArtOShophyInvoiceScreen extends StatefulWidget {
  ...
  @override
  State<ArtOShophyInvoiceScreen> createState() =>
      _ArtOShophyInvoiceScreenState();
}

class _ArtOShophyInvoiceScreenState extends State<ArtOShophyInvoiceScreen> {
  ...
  Future<void> _createPdf() async {
    Uint8List artOShophyLogoImage =
        (await rootBundle.load(PickImages.artOShophyLogoImage))
            .buffer
            .asUint8List();
    Uint8List artosophyDesignersTusharImage =
        (await rootBundle.load(PickImages.artosophyDesignersTusharImage))
            .buffer
            .asUint8List();
    // Uint8List imageData =
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Container(
                          ...
                          decoration: pw.BoxDecoration(
                            image: pw.DecorationImage(
                              image: pw.MemoryImage(artOShophyLogoImage),
                              fit: pw.BoxFit.fill,
                            ),
                          ),
                        ),
                        ...
                        pw.Container(
                          ...
                          decoration: pw.BoxDecoration(
                            image: pw.DecorationImage(
                              image:
                                  pw.MemoryImage(artosophyDesignersTusharImage),
                              fit: pw.BoxFit.contain,
                            ),
                          ),
                          // ),
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Align(
                            ...
                            child: pw.Text("ART O SOPHY DESIGNERS",
                                style: pw.TextStyle(
                                    fontSize: 12,
                                    fontWeight: pw.FontWeight.bold)),
                          ),
    ...
    await Printing.layoutPdf(
      name:
          '${projectNoController.text} INVOICE ${dateController.text.replaceAll('_', '/')} ${clientNameController.text.toUpperCase()} ARTOSOPHY',
