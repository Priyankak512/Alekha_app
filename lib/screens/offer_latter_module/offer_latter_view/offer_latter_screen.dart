...
//Create PDF :
  ...
  Future<void> _generatePDF() async {
                ...
                children: [
                  pw.Expanded(
                    ...
                    child: buildInlineTextFieldRow(
                        'CLIENT : ',
                        "${clientNameController.text}(${contactNoController.text})",
                        calibriBoldFont,
                        calibriRegularFont),
                  ),
                  pw.Expanded(
    ...
    pdf.addPage(
     ...
     3D Design - Includes ${elevation3DOptionalController.text} Revisions${revision3DOptionalController.text.isNotEmpty ? " & ${revision3DOptionalController.text} Revisions" : ""}
...
//////#rd Page
    ...
    await Printing.layoutPdf(
      name:
          'OFFER LETTER ${dateController.text.replaceAll('_', '/')} ${clientNameController.text.toUpperCase()}',
