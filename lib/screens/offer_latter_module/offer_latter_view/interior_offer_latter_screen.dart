...
class InteriorOfferLetterScreen extends StatefulWidget {
  const InteriorOfferLetterScreen({super.key});

  @override
  State<InteriorOfferLetterScreen> createState() =>
      _InteriorOfferLetterScreenState();
}

class _InteriorOfferLetterScreenState extends State<InteriorOfferLetterScreen> {
  String? _feeStage1;
  String? _feeStage2;
  String? _feeStage3;
  String? _feeStage4;
  ...
  TextEditingController aPremiumOtherController = TextEditingController();
  TextEditingController bPremiumOtherController = TextEditingController();
  TextEditingController cPremiumOtherController = TextEditingController();
  TextEditingController dPremiumOtherController = TextEditingController();
  TextEditingController ePremiumOtherController = TextEditingController();
  TextEditingController fPremiumOtherController = TextEditingController();
  ...
  List<Map<String, dynamic>> interiorBasicOptions = [];
  List<Map<String, dynamic>> interiorStandardOptions = [];
  List<Map<String, dynamic>> interiorPremiumOptions = [];
  ...
  void initState() {
    ...
    interiorBasicOptions =
        List<Map<String, dynamic>>.from(GlobalList.interiorBasicOptions);
    interiorStandardOptions =
        List<Map<String, dynamic>>.from(GlobalList.interiorStandardOptions);
    interiorPremiumOptions =
        List<Map<String, dynamic>>.from(GlobalList.interiorPremiumOptions);
  ...
  //Fees Lists
  final selectedBasicOptions = GlobalList.interiorBasicOptions
      .where((e) => e['isChecked'] == true)
      .toList();
  final selectedStandardOptions = GlobalList.interiorStandardOptions
      .where((e) => e['isChecked'] == true)
      .toList();
  final selectedPremiumOptions = GlobalList.interiorPremiumOptions
      .where((e) => e['isChecked'] == true)
      .toList();
//Create PDF :
  ...
  Future<void> _generatePDF() async {
    final selectedBasicOptions =
        interiorBasicOptions.where((e) => e['isChecked'] == true).toList();
    final selectedStandardOptions =
        interiorStandardOptions.where((e) => e['isChecked'] == true).toList();
    final selectedPremiumOptions =
        interiorPremiumOptions.where((e) => e['isChecked'] == true).toList();
    ...
    Uint8List imageData =
        (await rootBundle.load(PickImages.offerLetterInteriorHeaderImage))
            .buffer
            .asUint8List();
                    ...
                    pw.Container(
                        ...
                        child: pw.Row(
                          ...
                          children: [
                            ...
                            pw.SizedBox(
                                width: 12), // Spacing between image and grid
...
""",
    ...
    await Printing.layoutPdf(
      name:
          'OFFER LETTER INTERIOR ${clientNameController.text.toUpperCase()} ${dateController.text.replaceAll('_', '/')} ',
      ...
      if (aPremiumController.text.trim().isNotEmpty &&
        ...
        selectedStages.add({
          ...
          "label": _feeStage1 == "Other"
              ? aPremiumOtherController.text.trim().isNotEmpty
                  ? aPremiumOtherController.text.trim()
                  : "Other"
              : _feeStage1!
        });
      }
      if (bPremiumController.text.trim().isNotEmpty &&
        ...
        selectedStages.add({
          ...
          "label": _feeStage2 == "Other"
              ? bPremiumOtherController.text.trim().isNotEmpty
                  ? bPremiumOtherController.text.trim()
                  : "Other"
              : _feeStage2!
        });
      }
      if (cPremiumController.text.trim().isNotEmpty &&
        ...
        selectedStages.add({
          ...
          "label": _feeStage3 == "Other"
              ? cPremiumOtherController.text.trim().isNotEmpty
                  ? cPremiumOtherController.text.trim()
                  : "Other"
              : _feeStage3!
        });
      }
      if (dPremiumController.text.trim().isNotEmpty &&
        ...
        selectedStages.add({
          ...
          "label": _feeStage4 == "Other"
              ? dPremiumOtherController.text.trim().isNotEmpty
                  ? dPremiumOtherController.text.trim()
                  : "Other"
              : _feeStage4!
        });
      }
      if (ePremiumController.text.trim().isNotEmpty &&
        ...
        selectedStages.add({
          ...
          "label": _feeStage5 == "Other"
              ? ePremiumOtherController.text.trim().isNotEmpty
                  ? ePremiumOtherController.text.trim()
                  : "Other"
              : _feeStage5!
        });
      }
      if (fPremiumController.text.trim().isNotEmpty &&
        ...
        selectedStages.add({
          ...
          "label": _feeStage6 == "Other"
              ? fPremiumOtherController.text.trim().isNotEmpty
                  ? fPremiumOtherController.text.trim()
                  : "Other"
              : _feeStage6!
        });
      }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 10.0,
                      runSpacing: -8.0,
                      children: interiorBasicOptions.map((option) {
                        return SizedBox(
                    ...
                    Wrap(
                      spacing: 10.0,
                      runSpacing: -8.0,
                      children: interiorStandardOptions.map((option) {
                        return SizedBox(
                          width: MediaQuery.of(context).size.width / 2 - 16,
                          child: CheckboxListTile(
                            visualDensity: const VisualDensity(
                    ...
                    Wrap(
                      spacing: 10.0,
                      runSpacing: -8.0,
                      children: interiorPremiumOptions.map((option) {
                        return SizedBox(
                          width: MediaQuery.of(context).size.width / 2 - 16,
                          child: CheckboxListTile(
                            visualDensity: const VisualDensity(
                    ...
                    PickHeightAndWidth.height20,
                    LabelAndTextFieldRow(
                      label: "Additional 3D designs",
                      controller: elevation3DController,
                      labelText: "Amount/Space",
                      hintText: "Amount/Space",
                      keyboardType: TextInputType.number,
                    ),
                    PickHeightAndWidth.height10,
                    LabelAndTextFieldRow(
                    ...
                    if (_feeStage1 == "Other")
                      Padding(
                        ...
                        child: CommonTextFieldWithFocus(
                          controller: aPremiumOtherController,
                    ...
                    if (_feeStage2 == "Other")
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: CommonTextFieldWithFocus(
                          controller: bPremiumOtherController,
                    ...
                    if (_feeStage3 == "Other")
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: CommonTextFieldWithFocus(
                          controller: cPremiumOtherController,
                    ...
                    if (_feeStage4 == "Other")
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: CommonTextFieldWithFocus(
                          controller: dPremiumOtherController,
                    ...
                    if (_feeStage5 == "Other")
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: CommonTextFieldWithFocus(
                          controller: ePremiumOtherController,
                    ...
                    if (_feeStage6 == "Other")
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: CommonTextFieldWithFocus(
                          controller: fPremiumOtherController,
