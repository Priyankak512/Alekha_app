...
class OtherFormsScreen extends StatefulWidget {
  const OtherFormsScreen({Key? key}) : super(key: key);

  @override
  State<OtherFormsScreen> createState() => _CreatePdfFromDataState();
}

class _CreatePdfFromDataState extends State<OtherFormsScreen> {
  ...
  Future<void> _generatePDF() async {
    ...
    pdf.addPage(
      pw.Page(margin: const pw.EdgeInsets.all(20),
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              // Carpet Area
              _buildTextFieldRow(
                  'Requirements : ', requirementsController.text, pdf),
